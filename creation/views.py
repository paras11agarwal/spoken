                ...
                try:
                    ...
                    if component == 'video':
                        ...
                        if check_status is 0:                        
                            ...
                            if(ratio<0.5 and mean<0.30):
                                #creating the noNoise video
                                ...
                                command="ffmpeg -i /tmp/noisefree.wav "+full_path[:-4]+".mp3"
                                subprocess.call(command,shell=True)
                                print "------------------------------5-------------------------------"

                                command="ffmpeg -i "+full_path+" -an -codec copy "+file_path+"noaudio.mov"
                                subprocess.call(command,shell=True)

                                command="ffmpeg -i "+file_path+"noaudio.mov -vcodec libvpx -cpu-used -5 -deadline realtime "+full_path[:-4]+".webm"
                                subprocess.call(command,shell=True)
                                ...
                                subprocess.call(cmd,shell=True)
                                print "----------------------------------9--------------------------"
                                cmd="mv "+file_path+"final_video.ogv "+full_path
                                #subprocess.call(cmd,shell=True)
                                print "----------------------------------10--------------------------"
                            else:
                                check_status=2
