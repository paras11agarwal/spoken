...
{div.style.backgroundColor="#ffffff";}}
var trackedPlayer=document.getElementById('video1');var trackaudio=document.getElementById('audio1');var previousTime=0;var currentTime=0;currentTime=trackaudio.currentTime;var cur_time=formatTime(currentTime).toString();trigger(cur_time);$("#text").click(function(e)
