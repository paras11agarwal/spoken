...
var trackedPlayer=videojs('st_video');var audio=document.getElementById('st_audio')
var previousTime=0;var currentTime=0;trackedPlayer.on('timeupdate',function(){previousTime=currentTime;currentTime=trackedPlayer.currentTime();audio.currentTime=currentTime;audio.volume=trackedPlayer.volume();if(trackedPlayer.played())
audio.play();else if(trackedPlayer.paused())
audio.pause();var cur_time=formatTime(currentTime).toString();trigger(cur_time);$("#text").click(function(e){trackedPlayer.pause()
