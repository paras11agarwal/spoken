...
{var trackedvideo=document.getElementById('video1');var trackaudio=document.getElementById('audio1');var currentTime=trackedvideo.currentTime;var cur_time=formatTime(currentTime).toString();trackaudio.pause();trackedvideo.pause();alert("fffff");setForum(cur_time);});function setForum(cur_time)
...
alert("ff");var url="http://forums.spoken-tutorial.org/new-question/?category=Java&tutorial=Getting started java Installation&minute_range="+min_range+"&second_range="+sec_range;$("#text").attr("href",url);}