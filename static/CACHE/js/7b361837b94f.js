function report(language){var audi=document.getElementById('audio1');var auid=document.getElementById('audio');var vid=document.getElementById('video1');alert(vid.textTracks.length);auid.setAttribute("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".mp3");var video=document.getElementById("video1"),track;track=document.createElement("track");track.kind="captions";track.label=language;track.src="/media/videos/10/273/Getting-started-java-Installation-"+language+".srt";track.mode="showing";vid.controls=true;vid.pause();audi.pause();vid.load();audi.load();vid.play();audi.play();}
