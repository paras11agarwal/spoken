function report(language){var array="Getting-started-java-Installation".split('-');alert(array);var data=array.join('%2B');alert(data);$("#myform").attr("action","http://localhost:8000/watch/Java/"+data+"/"+language);}
