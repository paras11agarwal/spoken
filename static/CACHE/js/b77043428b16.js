function report(language){var audi=document.getElementById('audio1');var auid=document.getElementById('audio');var vid=document.getElementById('video1');var sub=document.getElementById('subtitle');]
alert($('#video1 track').src);auid.setAttribute("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".mp3");$('#video1 track').prop("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".srt");$('#video1 track').prop("label",language);vid.pause();audi.pause();$('#video1 track').load();vid.load();audi.load();vid.play();audi.play();}
