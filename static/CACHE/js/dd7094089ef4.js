function report(language){var audi=document.getElementById('audio1');var auid=document.getElementById('audio');var vid=document.getElementById('video1');alert(vid.textTracks.length);auid.setAttribute("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".mp3");var video=document.getElementById("video1"),track;video.addEventListener("loadedmetadata",function(){track=document.createElement("track");track.kind="captions";track.label=lenguage;track.src="/media/videos/10/273/Getting-started-java-Installation-"+language+".srt";track.addEventListener("load",function(){this.mode="showing";video.textTracks[0].mode="showing";});this.appendChild(track);});vid.controls=true;vid.pause();audi.pause();vid.load();audi.load();vid.play();audi.play();}
