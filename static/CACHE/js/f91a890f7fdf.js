function report(language){var array="Getting-started-java-Installation".split('+');var data=array.join('%2B');alert(data);$.ajax({type:'GET',url:"http://localhost:8000/watch/Java/"+data+"/"+language,success:function(){alert("sss");}});}
