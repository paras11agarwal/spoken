(function(){new syncAudioVideo('video1','audio1');var vid=document.getElementById('video1');})();var trackedPlayer=document.getElementById('video1');var currentTime=trackedPlayer.currentTime;var cur_time=formatTime(currentTime).toString();trigger(cur_time);$(document).ready(function()
