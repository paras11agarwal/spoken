...
{previousTime=currentTime;currentTime=trackedPlayer.currentTime;var cur_time=formatTime(currentTime).toString();alert(currentTime);trigger(cur_time);$("#text").click(function(e)
{trackedPlayer.pause()
