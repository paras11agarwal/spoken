...
{div.style.backgroundColor="#ffffff";}}
var trackedPlayer=document.getElementById('video1');var trackaudio=document.getElementById('audio1');var currentTime=trackaudio.currentTime;var cur_time=formatTime(currentTime).toString();trigger(cur_time);$("#text").click(function(e)
{var trackaudio=document.getElementById('audio1');var currentTime=trackaudio.currentTime;var cur_time=formatTime(currentTime).toString();alert(currentTime);alert(cur_time);trackaudio.pause();trackedPlayer.pause();setForum(cur_time);});function setForum(cur_time)
