(function(){new syncAudioVideo('video1','audio1');var vid=document.getElementById('video1');alert(vid.currentTime());})();function trigger(cur_time,duration){min_range='00-01'
sec_range='0-10'
id='459'
...
var ct=document.getElementById('video1');var currentTime=ct.currentTime;var cur_time=formatTime(currentTime).toString();trigger(cur_time);setForum(cur_time);function setForum(cur_time)
