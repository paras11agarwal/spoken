...
{var trackaudio=document.getElementById('audio1');var currentTime=trackaudio.currentTime;alert(currentTime);alert(cur_time);trackaudio.pause();trackedPlayer.pause();setForum(cur_time);});function setForum(cur_time)
