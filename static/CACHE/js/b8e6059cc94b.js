function report(language){var audi=document.getElementById('audio1');var auid=document.getElementById('audio');var vid=document.getElementById('video1');$('video track').removeAttr('default');$('video track[src="/media/videos/10/273/Getting-started-java-Installation-"+language+".srt"]').attr('default','default');auid.setAttribute("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".mp3");alert(vid.textTracks);vid.pause();audi.pause();vid.load();audi.load();vid.play();audi.play();}
