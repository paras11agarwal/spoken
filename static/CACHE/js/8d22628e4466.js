function report(language){var audi=document.getElementById('audio1');var auid=document.getElementById('audio');var vid=document.getElementById('video1');auid.setAttribute("src","/media/videos/10/273/Getting-started-java-Installation-"+language+".mp3");vid.pause();audi.pause();alert("dd");alert("<track kind="captions" src="/media/videos/10/273/Getting-started-java-Installation-English.srt" srclang="en" label="English"></track>");vid.load();audi.load();vid.play();audi.play();}
...
{var trackedvideo=document.getElementById('video1');var trackaudio=document.getElementById('audio1');var currentTime=trackedvideo.currentTime;var cur_time=formatTime(currentTime).toString();trackaudio.pause();trackedvideo.pause();setForum(cur_time);});function setForum(cur_time)
